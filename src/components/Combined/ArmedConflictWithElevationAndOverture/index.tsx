...
import { GELPMTilesSource as terrainSource } from "../../../components/Datasets/GEL/source";
import { OvertureMapsTransportationOnlyPMTilesSource as transportationSource } from "../../Datasets/OvertureMaps/source";

export const ArmedConflictWithElevationAndOverture: React.FC<{ mapStyle: string }> = ({
  mapStyle,
}) => {
  useEffect(() => {
